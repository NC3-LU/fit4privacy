...
INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('Q010', 'Has your company appointed a privacy responsible or a Data Protection Officer (DPO)?', 'fr', 'Q');
    ...
    INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('Q010A004', 'We have a privacy responsible but not a formal DPO.', 'fr', 'A');
...
INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('Q012', 'How many contracts with contractors/ partners have you reviewed after May 2018, with respect to GDPR clauses and personal data being processed?', 'fr', 'Q');
    ...
    INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('Q012A004', 'All of the contracts in place have been reviewed and updated.', 'fr', 'A');
...
INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('Q014', 'If there are any transfers of personal data processed by your company, to the outside of the the European Economic Area (EU plus Iceland, Lichtenstein, Norway), what are the legal measures of protection in place?', 'fr', 'Q');
    ...
    INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('Q014A004', 'No idea what we have in place, but we do have transfers of personal data.', 'fr', 'A');
...
INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('Q015', 'How do you handle information security risks?', 'fr', 'Q');
    ...
    INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('Q015A004', 'We review our risks periodically and we perform external audit regularly or we have an information security certification (e.g ISO 2700x).', 'fr', 'A');
...
INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('Q002REC002', 'Pay attention to the regime of treating the data relative to criminal records. Even if it is not sensitive data, it should be treated in the same way as the sensitive data mentioned in the second question.', 'fr', 'R');
...
INSERT INTO "survey_translationkey" ("key", "text", "lang", "ttype") VALUES ('Q011REC004', 'Even if the CNPD has given its green light in the past for an impact analysis, it does not mean that the situation is the same now. They would expect that any changes in the processing from then to now, are accounted to in the (renewed) analysis. Also, do not forget that the CNPD published a black list of processing activities, that are likely to require an impact assessment. ', 'fr', 'R');
