...
TRANSLATION_UI = {
    "report": {
        ...
        "description": {
            "en": "This is the list of recommendations to improve the maturity of your company in the field of privacy and data protection, provided that your answers correctly reflected the state of practice in your company. Also keep in mind that it is a self-assessment and only scratches the surface of the privacy and data protection maturity level and thus, we are not liable for the results of this survey.",
            "fr": "Voici la liste des recommandations visant à améliorer la maturité de la protection des données à caractère personnel dans votre entreprise, à condition que vos réponses reflètent correctement l'état de votre entreprise. N'oubliez pas non plus qu'il s'agit d'une auto-évaluation et qu'elle ne fait qu'effleurer le niveau de maturité de la protection de la vie privée et protection des données. Par conséquent, nous ne sommes pas responsables des résultats de cette enquête.",
            "de": "Dies ist die Liste der Empfehlungen zur Verbesserung der Datenschutz in Ihrem Unternehmen, sofern Ihre Antworten den Status in Ihrem Unternehmen korrekt widerspiegeln. Denken Sie auch daran, dass es sich um eine Selbsteinschätzung handelt, die nur die Oberfläche des Reifegrads der Datenschutz abbilden kann, und wir daher nicht für die Ergebnisse dieser Umfrage haften.",
        },
        "title": {
            "en": "final summary",
            "fr": "résumé final",
