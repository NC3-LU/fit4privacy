...
TRANSLATION_UI = {
    "report": {
        ...
        "description": {
            "en": "This is the list of recommendations to improve the maturity of your company in the field of GDPR, provided that your answers did correctl the state in your company. Also keep in mind that it is a self-assessment and only scratches the surface of the information security maturity level and thus, we are not liable for the results of this survey.",
